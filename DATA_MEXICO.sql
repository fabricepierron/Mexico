INSERT INTO `photos` (`ID_PHOTO`, `ID_PJ`, `REPERTOIRE`, `NOM_PHOTO`, `LONGITUDE`, `LATITUDE`, `DESCRIPTION_FR`, `DESCRIPTION_ES`, `ADRESSE_FR`, `ADRESSE_ES`, `PRECISIONLOC`, `ORDRE`, `DATE_PHOTO`, `STREET_VIEW`, `ANGLE_VUE`) VALUES
